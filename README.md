...
CSS preprocessors let you generate CSS from the preprocessor's own unique syntax

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

LESS is my favorite. I haven't really looked into any other concepts.

3. How would you explain the concept of a variable to someone new to programming?

As Britt says, the variable is like a jar/contaner that stores information that can be used later.

4. What is the purpose of using functions in code?.

Functions are small sections of code that are used to perform a particular task.

5. What is a JSON data?

JavaScript Object Notation readable format for structuring data. It is used primarily to transmit data between a server and web application.
